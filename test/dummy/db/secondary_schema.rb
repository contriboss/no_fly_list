...
ActiveRecord::Schema[7.2].define(version: 20_241_203_220_126) do
  create_table 'bus_taggings', force: :cascade do |t|
    ...
    t.index %w[taggable_id tag_id], name: 'index_bus_taggings_on_taggable_id_and_tag_id', unique: true
  ...
  create_table 'car_taggings', force: :cascade do |t|
    ...
    t.index %w[taggable_id tag_id], name: 'index_car_taggings_on_taggable_id_and_tag_id', unique: true
  ...
  create_table 'truck_taggings', force: :cascade do |t|
    ...
    t.index %w[taggable_id tag_id], name: 'index_truck_taggings_on_taggable_id_and_tag_id', unique: true
